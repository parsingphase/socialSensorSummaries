...
export type DailyDetectionsQuery = {
  __typename?: "Query";
  dailyDetectionCounts: Array<{
    __typename?: "BinnedSpeciesSummaryCount";
    date: any;
    dayOfYear: number;
    counts: Array<{
      __typename?: "SummarySpeciesCount";
      count: number;
      species: { __typename?: "Species"; alpha?: string | null; commonName: string };
    }>;
  }>;
};
  ...
  detections: {
    ...
    edges?: Array<{
      ...
      node?: {
        ...
        score: number;
        species: { __typename?: "Species"; commonName: string };
      } | null;
    } | null> | null;
  };
};

export const DailyDetectionsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "DailyDetections" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "stationId" } },
          type: {
            kind: "NonNullType",
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "dailyDetectionCounts" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "stationIds" },
                value: {
                  kind: "ListValue",
                  values: [{ kind: "Variable", name: { kind: "Name", value: "stationId" } }],
                },
              },
              {
                kind: "Argument",
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "dayOfYear" } },
                {
                  kind: "Field",
...
} as unknown as DocumentNode<DailyDetectionsQuery, DailyDetectionsQueryVariables>;
export const AllDetectionsInPeriodDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "AllDetectionsInPeriod" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "stationId" } },
        ...
        },
        {
          ...
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "ISO8601Date" } },
          },
        },
        {
          kind: "VariableDefinition",
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "detections" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "stationIds" },
...
} as unknown as DocumentNode<AllDetectionsInPeriodQuery, AllDetectionsInPeriodQueryVariables>;
