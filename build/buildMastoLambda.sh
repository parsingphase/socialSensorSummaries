...
DIST_DIR="${SCRIPT_DIR}/../dist/masto"
BUILD_DIR="${SCRIPT_DIR}"
OUTPUT_DIR="${BUILD_DIR}/output"

cd "${SCRIPT_DIR}"
rollup -c rollup-masto.config.mjs
...
rm -rf "${OUTPUT_DIR}/mastoLambda.zip"
...
rm -rf "${OUTPUT_DIR}/mastoLambda.zip"
mkdir -p "${OUTPUT_DIR}"
zip -r "${OUTPUT_DIR}/mastoLambda.zip" * > /dev/null

ls -lh "${OUTPUT_DIR}/mastoLambda.zip"
